...
{
    system("cls");
    clsEmployee Emp(1, "Fars", "Mostafa", "Developer", "fares.moostafa@gmail.com", "01093649229", 20000, "IT");
    Emp.PrintInfo();
    Emp.SendEmail("Course 10", "this course is about OOP");
    Emp.SendSMS("Dear Fars Mostafa, Thanks for studing this course.");
